...
#     print("{:20}: {:0.2f}".format('% Correct Dogs', results_stats_dic['pct_correct_dogs']))
#     print("{:20}: {:0.2f}".format('% Correct Breed', results_stats_dic['pct_correct_breed']))
#     print("{:20}: {:0.2f}".format('% Correct Not-a Dog', results_stats_dic['pct_correct_notdogs']))
#     print("{:20}: {:0.2f}".format('% Match', results_stats_dic['pct_match']))
    
    # User wants to print misclassifications:
    # print_incorrect_dogs == True    
#     if print_incorrect_dogs and (results_stats_dic['n_correct_dogs'] + results_stats_dic['n_correct_notdogs']) != results_stats_dic['n_images']:
#         print("print_incorrect_dogs")
        
      
    #     User wants to print misclassifications:
    # print_incorrect_breed == True
#     if print_incorrect_breed and results_stats_dic['n_correct_dogs'] != results_stats_dic['n_correct_breed']:
#         print("print_incorrect_breed")
...
#     print(" ***  *** ")
    for key, value in results_stats_dic.items():
        ...
        #
        if key[0] == 'p':
            print("{:20}: {:0.2f}".format(key, value))
